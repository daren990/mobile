...
public class ToolUtility {
    ...
    public static final String USER_KEY = "ee11cbb19052e40b07aac0ca060c23ee";
    public static final String WEBSITE_URL = "https://m.fakafa.com/";
    ...
    public static String getIpAddr(HttpServletRequest request) {
        ...
        ip = StringUtil.isBlank(ip) ? "0.0.0.0" : ip;
        if (ip.indexOf(",") > 0)
    ...
    public static String getCookieValue(HttpServletRequest request, String name) {
        ...
        for (Cookie ck : cookies) {
            if (TagUtil.equalsIgnoreCase(name, ck.getName()))
                return ck.getValue();
        }
        return null;
    }
    ...
    public static boolean verifyEmail(String email) {
        ...
        if (StringUtil.isBlank(email.trim()) || email.length() < 5)
    ...
    public static boolean verifyMobile(String mobi) {
        ...
        if (StringUtil.isBlank(mobi.trim()))
            return false;
    ...
    public static boolean verifyIdCard(String idCard) {
        if (StringUtil.isBlank(idCard.trim()))
            return false;
        if (idCard.length() == 15)
    ...
    public static String getValueFromJson(String jsonStr, String field,
                                          String tailField) {
        if (StringUtil.isBlank(jsonStr.trim())
                || StringUtil.isBlank(field.trim())
                || StringUtil.isBlank(tailField.trim()))
            return null;
        else {
    ...
    public static boolean sqlValidate(String str) {
        ...
        String badStr = "'|and|exec|execute|insert|select|delete|update|count|drop|*|%|chr|mid|master|truncate|" +
                ...
                "table|from|grant|use|group_concat|column_name|limit|sleep|" +
